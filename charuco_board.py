...
def generate_charuco_board(paper_width, paper_height, fixed_square_size, dpi, margin, output_filename):
...
# A4 paper dimensions in meters, fixed square size, and margin
